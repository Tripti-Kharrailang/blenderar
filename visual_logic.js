...
createCSSRule('.enter-AR-button', "position: absolute; display: block; z-index: 1; background-color: rgda(255,255,255,0); width: 200px; height: 50px; bottom: 20px; left: 50%; margin-left: -100px; background-size: 100%; cursor: pointer; outline: 0;", false, '');
...
createCSSRule('.warning-could-not-enter-AR', "position: absolute; width: 181px; height: 50px; left: 50%; margin-left: -90px; display: none; z-index: 1;", false, '');
...
setHTMLElemAttribute('href', 'https://triptik.com', 'info_button', false);
...
operateAnimation('PLAY', 'miku_armature', 0, 217, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('miku_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'miku_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'miku_armature', 217, 275, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'miku_group'], false);
      ...
      changeVis(['GROUP', 'miku_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('miku_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('miku_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('miku_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'miku.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'miku_group'], true);
  setObjTransform('miku_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('miku_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
  changeVis(['ready_button', 'edit_button', 'drag_move', 'drag_rotate', 'drag_scale', 'scale_percentage'], false);
  changeVis(['GROUP', 'indicator_group'], false);
}, function() {});
...
registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('miku_armature', 'Z', 'WORLD', 'fb-.JGw,E66H@*}!B2,!', 'a^+1vM`D;GcMAbvh)U70');
}, function() {}, 'a^+1vM`D;GcMAbvh)U70');

registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('miku_armature', 'XY', 'WORLD', '2qDjO.1G]S2h:CC7,^}{', '!sft#FqNktDPy/*!w#=2');
}, function() {}, '!sft#FqNktDPy/*!w#=2');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('miku_armature', 'Z', 'BV}C9.zaMN(Tj|zsn0Sr', 'ML*-GN(I.*2BKlu;$Fuo');
  dragScale('miku_armature', 'X', 'z6Ifl{pCTpZ*(5u0o*qe', 'ML*-GN(I.*2BKlu;$Fuo');
  dragScale('miku_armature', 'Y', 'X[tQQ+o_B#nAh^O~|H3y', 'ML*-GN(I.*2BKlu;$Fuo');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('miku_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'ML*-GN(I.*2BKlu;$Fuo');
